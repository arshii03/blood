...
import Cards from '../donars/Cards'
...
const Request = () => {
  return (
    ...
    <div className="container-fluid pt-5 mb-5">
      <div className="row">
        <div className="col-12 col-sm-6  align-middle align-self-center">
          <h2 className='textarea'>Urgent Appeal: Donate Blood, Save Lives</h2>
          ...
          <button className='btn btn-danger rounded-pill px-4 mx-2'>Request for blood</button>
          <button className='btn btn-outline-danger rounded-pill px-4'>Learn More</button>
          </div>
        </div>
        <div className="col-12 col-sm-6">
          <img className='img' src="/images/image55.png" alt="" />
        </div>
        <div className="row">
          <div className="col-12 mt-5">
            <nav className='navbar d-flex '>
          <a class="navbar-brand txt">Request for Blood</a>
    <form className="d-flex d" role="search">
      ...
      <button className="btn btn-danger rounded-pill px-5" type="submit">Search</button>
    </form>
    </nav>
